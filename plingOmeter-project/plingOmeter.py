...
class plingOmeter:
  def __init__(self):
    ...
    self.script_dir = "/home/dgmusic/dgmusic/dg_pling/plingOmeter-project" #<-- absolute dir the script is in
    #self.fileName = '../pling-project/plingStats.csv'
    self.fileName = '/home/dgmusic/dgmusic/dg_pling/pling-project/plingStats.csv'
    ...
    icon = tkinter.PhotoImage(file='/home/dgmusic/dgmusic/dg_pling/plingOmeter-project/files/iconOmeter.pgm')
  ...
  def readStats(self):
    ...
    csvfile = open(self.abs_file_path, 'rt') 
...
def main(observer):
  ...
  script_dir = "/home/dgmusic/dgmusic/dg_pling/plingOmeter-project" #<-- absolute dir the script is in
